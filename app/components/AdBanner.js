...
// Renders two ad banners unless the user has gone premium. Reads the premium
// flag from localStorage after mount to avoid hydration mismatches.
...
export default function AdBanner() {
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener("premium-changed", syncPremium);
